...
async function searchbusinessfunc(event){
  event.preventDefault() 
  setSearchCity(thiscity)
  setSearchTerm(thissearchterm)
randomtext()
}
const [thiscity, setthiscity] = useState()
const [thissearchterm, setthissearchterm] = useState()
    ...
    <Grid item>
      <form onSubmit={searchbusinessfunc}>
        <TextField
          ...
          // onSubmit={randomtext()}
          onChange={(event)=> setthiscity(event.target.value)}
        />
              <TextField
          // id="outlined-search"
          label="Search Term"
          ...
          variant="outlined"
          // value={searchTerm}
          onChange={(event)=> setthissearchterm(event.target.value)}
          // onSubmit={randomtext()}
        />
        <Button onClick={searchbusinessfunc}>
        Search
        </Button>
